...
def formatNewick(racine, distToParent):
    '''Arguments:
            1. racine, la racine de l'arbre qu'on veut formatter dans la
                format Newick
               racine, the root of the tree that we want to format in the
                specieal Newick format.
            2. distToParent, la distance à la parent, seulement utilisé pour
                ...
                est None.
               distToParent, the distance to the parent, only used for the leaves.
                If the root is not a leaf, distToParent is None.
       Output:
            1. Un string de l'arbre ou sous-arbre en format Newick.
               A string which represents the tree or sub-tree in Newick format.
       Purpose:
            ...
            This is a recursive function which traverses the tree and constructs
                a string in Newick format, to display the only the leaves and the
